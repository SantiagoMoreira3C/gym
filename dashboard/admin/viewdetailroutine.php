...
<head>
    ...
    <title>GIM4K | Datos de Rutina</title>
	...
	function myFunction()
	{
     ...
     <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<div id=print>
		<table width="619" height="673" class="table table-bordered datatable a1-table-all" id="table-1" border=2 align="center">
  ...
  <tr>
    ...
    <td><?php echo $row['day6'] ?></td>
							  ...
							  <br>
				<input type="button" class="a1-btn a1-indigo" style="width: 200px; "  value="Imprimir Rutina" onclick="myFunction()">
