...
<head>
    ...
    <title>GIM4K | Cliente ingresados durante el año</title>
...
<li>
	<a style="font-size: 20px;" href="logout.php">
		...
		<h2  class="a1-serif"><strong>Cliente por año</strong></h2>
	...
	<input type="button" class="a1-btn a1-amber"  style="margin-bottom:5px;" name="search" onclick="showMember();" value="Search">

	</form>
	<table id="meyear" class="table table-bordered datatable a1-table-all" id="table-1" border=2>
