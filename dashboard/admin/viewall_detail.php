...
<head>
    ...
    <title>GIM4K | Editar Cliente</title>
    ...
    <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<div class="sidebar-menu">
			...
			<h3 class="a1-serif"> <strong>Editar Detalles de Cliente</strong> </h3>
			<hr/>
			...
			<?php
				    ...
				    if (mysqli_affected_rows($con) == 1) {
				        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				    	 ...
				    	 echo "<html><head><script>alert('Su cambio no se pudo realizar');</script></head></html>";
		...
		<div class="a1-pale-blue a1-hover-blue a1-center">
        	<h6 style="font-size: 24px"  >Editar Datos de Cliente</h3>
        </div>
         ...
         <tbody><tr>
           <td height="35">
             ...
             <tr>
               ...
               <td height="35">&nbsp;</td>
               <td height="35">
				   <input class="a1-btn a1-aqua" type="submit" name="submit" id="submit" value="Editar">
                 <a href="table_view.php"><input style="width: 20%; height:100%" class="a1-btn a1-pink" id="submit" value="Volver"></a></td>
             </tr>
