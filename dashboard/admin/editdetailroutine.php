...
<head>
    ...
    <title>GIM4K | Editar Rutina</title>
     ...
     <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<div class="sidebar-menu">
    		...
    		<div class="main-content">
				...
				<h2 class="a1-serif"><strong>Editar Rutina</strong></h2>
				<hr/>
...
<div class="a1-container a1-small a1-padding-32" style="margin-top:2px; margin-bottom:2px;">
		...
		<div class="a1-pale-blue a1-hover-blue a1-center">
        	<h6 style="font-size: 24px" >Editar datos de Rutina</h6>
        </div>
  ...
  <tr>
    ...
    <td   width='400'  colspan="2"><input type="text" name='routinename' value='<?php echo $row['tname'] ?>'></td>
    </tr>
  <tr>
    <td width="186" height="103">Primer dia:</td>
