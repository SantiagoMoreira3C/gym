...
<head>
	...
	<title>GYM4K | Pagina de Inicio </title>
			...
			<header class="logo-env">
				...
				<div class="sidebar-collapse" onclick="collapseSidebar()">
					<a href="#" class="sidebar-collapse-icon with-animation">
						<!-- agregue la clase "with-animation" si desea que la barra lateral tenga animación durante la transición de expansión / colapso -->
		...
		<div class="main-content">
			...
			<div class="col-sm-3"><a href="revenue_month.php">
					<div class="tile-stats tile-red">
						...
						<div class="num" data-postfix="" data-duration="1500" data-delay="0">
							<h2 align="center">Total <br> recibido</h2><br>
							<?php
			...
			<div class="col-sm-3"><a href="table_view.php">
					<div class="tile-stats tile-green">
						...
						<div class="num" data-postfix="" data-duration="1500" data-delay="0">
							<h2 align="center">Clientes <br>Totales</h2><br>
							<?php
			...
			<div class="col-sm-3"><a href="over_members_month.php">
					<div class="tile-stats tile-aqua">
						...
						<div class="num" data-postfix="" data-duration="1500" data-delay="0">
							<h2 align="center">Clientes <br> Ingresados</h2><br>
							<?php
							date_default_timezone_set("America/Bogota");
							$date  = date('Y-m');
			...
			<div class="col-sm-3"><a href="view_plan.php">
					<div class="tile-stats tile-blue">
						...
						<div class="num" data-postfix="" data-duration="1500" data-delay="0">
							<h2 align="center">Total de Planes de Entrenamientos </h2><br>
							<?php
