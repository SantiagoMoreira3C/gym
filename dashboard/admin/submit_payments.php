      ...
      $result=mysqli_query($con,$query1);
        ...
        if($result){
          ...
          if(mysqli_query($con,$query2)==1){
               ...
               echo "<head><script>alert('Pago Actualizado Correctamente ');</script></head></html>";
               echo "<meta http-equiv='refresh' content='0; url=payments.php'>";
            }
             
            else{
               echo "<head><script>alert('Pago no Ingresado se ha dado un fallo en Sistema');</script></head></html>";
              echo "error: ".mysqli_error($con);
            }
            
          }
          else{
            echo "<head><script>alert('Pago no Ingresado su sistema ha fallado');</script></head></html>";
            echo "error: ".mysqli_error($con);
          }
        ...
        {
          echo "<head><script>alert('Su pago no se ha podido ingresar');</script></head></html>";
          echo "error: ".mysqli_error($con);
        }
