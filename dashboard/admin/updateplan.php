...
page_protect();
   ...
   if(mysqli_query($con,$query1)){
            ...
            echo "<html><head><script>alert('Plan actualizado correctamente');</script></head></html>";
            echo "<meta http-equiv='refresh' content='0; url=view_plan.php'>";  
   }
   else{
    echo "<html><head><script>alert('ERROR! No se pudo actualizar el plan');</script></head></html>";
