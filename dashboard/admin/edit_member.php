...
<head>
    ...
    <title>GIM4K | Editar Ingreso</title>
    ...
    <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<div class="sidebar-menu">
			...
			<h3 class="a1-serif"> <strong>Editar datos del Ingreso</strong> </h3>
			<hr/>
			<?php
				    ...
				    if (mysqli_affected_rows($con) == 1) {
				        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				    	 ...
				    	 echo "<html><head><script>alert('Su cambio no se ah podido realizar');</script></head></html>";
		...
		<div class="a1-pale-blue a1-hover-blue a1-center">
        	<h6 style="font-size: 24px"  >Editar Datos del Ingreso</h6>
        </div>
       <form id="form1" name="form1" method="post" class="a1-container" action="edit_mem_submit.php">
         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
           	 <tr>
           	   <td height="35">Id del Cliente:</td>
			...
			<tr>
               <td height="35">Dirección domiciliaria:</td>
             ...
             <tr>
               <td height="35">&nbsp;</td>
               <td height="35"><input class="a1-btn a1-aqua" type="submit" name="submit" id="submit" value="Actualizar" >
                 <input class="a1-btn a1-indigo" type="reset" name="reset" id="reset" value="Borrar"></td>
             </tr>
           </table></td>
         </tr>
         </table>
