...
<head>
    ...
    <title>GIM4K | Clientes ingresados durante el Mes</title>
...
<li>
	<a style="font-size: 20px;" href="logout.php">
		...
		<h2 class="a1-serif"><strong>Clientes agregado por Mes</strong></h2>
...
<form>
	...
	<input type="button" class="a1-btn a1-amber"  style="margin-bottom:5px;" name="search" onclick="showMember();" value="Búsqueda">

</form>
<table id="memmonth" class="table table-bordered datatable a1-table-all" id="table-1" border=2>
