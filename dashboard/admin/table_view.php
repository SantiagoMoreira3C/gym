...
<head>
    ...
    <title>GIM4K | Datos de Cliente</title>
...
<li>
	<a style="font-size: 20px;" href="logout.php">
		...
		<h3 class="a1-serif"><strong>Datos de Cliente</strong></h3>
							    ...
							    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							        ...
							        if (mysqli_affected_rows($con) == 1) {
							            while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
							                ...
							                echo "<td><form action='viewall_detail.php' method='post'><input type='hidden' name='name' value='" . $uid . "'/><input type='submit' class='a1-btn a1-aqua' id='button1' value='Ver Todo ' class='btn btn-info'/></form></td></tr>";
							                $msgid = 0;
							            }
							        }
							    }
