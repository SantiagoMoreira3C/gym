  ...
  <link rel="stylesheet" href="../../css/style.css"  id="style-resource-5">
	...
	width:126px;
     ...
     <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<h2  class="a1-serif"><strong>Estado de Salud</strong></h2>
							    ...
							    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							        ...
							        if (mysqli_affected_rows($con) == 1) {
							            while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
							                ...
							                <input type='hidden' name='ugender' value='" . $ugender . "'/><input type='submit' class='a1-btn a1-pink' id='button1' value='Estado Salud' style='width:100%' class='btn btn-info'/></form></td></tr>";
							                $msgid = 0;
							            }
							        }
							    }
