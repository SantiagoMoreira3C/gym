...
<head>
   ...
   <title>GIM4K | Estado de Salud del Cliente</title>
     ...
     <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<div class="sidebar-menu">
    		...
    		<div class="main-content">
				...
				<h3 class="a1-serif"><strong>  Editar estado de Salud</strong></h3>
...
<div class="a1-container a1-small a1-padding-32" style="margin-top:2px; margin-bottom:2px;">
				<div class="a1-card-8 a1-light-gray" style="width:900px; margin:0 auto;">
					<div class="a1-pale-blue a1-hover-blue a1-center">
						<h6 style="font-size: 24px"  > <strong> Editar Estado de Salud del Cliente</strong></h6>
					</div>
       <form id="form1" name="form1" method="post" class="a1-container" action="">
         <table class="table table-bordered datatable a1-table-all "width="100%" border="2" align="center">
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
			...
			<td height="35">ID Plan:</td>
			   ...
			   <tr>
               <td height="35">Nombre de Cliente:</td>
            ...
            <tr>
             ...
             <tr>
               <td height="35">&nbsp;</td>
               <td height="35"><input class="a1-btn a1-teal a1-khaki" type="submit" name="submit" id="submit" value="Enviar" >
