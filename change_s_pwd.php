...
if (isset($user_id_auth) && isset($pass) && isset($key)) {
    ...
    if ($count == 1) {
        ...
        echo "<html><head><script>alert('Contraseña actualizada, iniciar sesión de nuevo ');</script></head></html>";
    ...
    echo "<html><head><script>alert('Confirmar contraseña esta incorrecta');</script></head></html>";
