...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-08-2021 a las 23:09:25
...
('1629210248', 'Barrio San Agustin', 'Manabi', 'Manta', '5666');
...
('alejandromendoza', '1234', '1234', 'Alejandro Mendoza');
...
(8, 'LOAUVT', '1629210248', '2021-08-17', '2021-09-17', 'yes');
...
(6, '26', '1.37', '50', '28', 'La rutina debe ser diaria', '1629210248');
...
('GRXVTY', 'Plan Unico', 'El plan que se usa diariamente', '1', 2, 'no'),
...
('LOAUVT', 'Plan Unico', 'El plan que se usa diariamente', '1', 3, 'yes'),
('POQKJC', 'Plan Mensual', 'Una suscripciÃ³n mensual que desbloquea toda la aplicaciÃ³n ConfiguroWeb GYM y el soporte del entrenador en el chat.', '1', 60000, 'no'),
('WYNXCI', 'Plan Unico', 'El plan que se usa diariamente', '1', 2, 'no');
...
(2, 'Rutina Extraordinaria', 'Pierna', 'Brazos', 'Gluteos', 'Pierna', 'Brazos', 'Gluteos');
...
('1629210248', 'Juan Carlos', 'Hombre', '0994582165', 'carlos@hotmail.com', '2002-08-06', '2021-08-17');
...
--
ALTER TABLE `health_status`
  MODIFY `hid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
